...
for m = 1,#models do
  model = torch.load('models/model_' .. models[m] .. '.t7'):double()
  ...
  torch.save('rdms/rdm' .. models[m].. '_' .. nRDLTrain .. '.t7', rdm_tmp)
...
torch.save('rdms/rdm_ensemble' .. nRDLTrain .. '.t7',rdm:div(#models))